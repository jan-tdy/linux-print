...
#
# --- Vendored into jan-tdy/linux-print ---
# Copied verbatim (this header block excepted) from
# https://github.com/fablabnbg/inkscape-silhouette
# at commit d8f067b2e649f32eb699bb1fa24385101956f149, file silhouette/Graphtec.py.
# See ../NOTICE.md for full attribution. This file remains GPL-2.0 licensed
# (see ../LICENSE), independently of the rest of this repository's MIT license.
# Modifications by JapySoft for this integration:
#   - Import of Transport/BLETransport changed from the absolute
#     "silhouette.Transport"/"silhouette.BLETransport" package path to a
#     relative import, since this copy ships as its own small package
#     instead of alongside the full inkscape-silhouette Inkscape extension.
#   - BLETransport is a local stub (Bluetooth LE is out of scope for this
#     integration, which is USB-only); see BLETransport.py in this directory.
#   - Bluetooth (classic RFCOMM) code paths are unchanged and still present,
#     but unused and untested here since nothing in linuxprint calls them.
# 2026-09-06  Vendored for linux-print's Plotter tab (Cameo 4/5 family, USB).
...
from .Transport import USBTransport, BluetoothTransport
from .BLETransport import BLETransport
